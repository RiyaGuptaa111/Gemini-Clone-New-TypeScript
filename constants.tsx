...
export const SUGGESTIONS = [
  {
    title: "Help me write",
    text: "an email to my boss about taking a vacation",
  ...
  },
  {
    ...
    text: "for a 3-day trip to Tokyo",
  ...
  {
    title: "Brainstorm",
    text: "team bonding activities for a remote group",
    icon: <path d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7zm2.85 11.1l-.85.6V16h-4v-1.3l-.85-.6C7.8 13.15 7 11.18 7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 2.18-.8 4.15-2.15 5.1z"/>
  },
  {
    title: "Understand",
    text: "how quantum entanglement works in simple terms",
...
export const GeminiIcon = ({ className = "w-8 h-8" }) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z" fill="url(#gemini_gradient)" />
    <defs>
